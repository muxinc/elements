...
export type Options = {
   ...
   */
  errorTranslator?: (error: ErrorEvent) => ErrorEvent;
};
 ...
 */
export function emit<K extends MuxEvents[keyof MuxEvents]>(
  playerId: PlayerId,
  type: K,
...
type MuxOnVideoElement = {
  ...
  emit: <K extends MuxEvents[keyof MuxEvents]>(type: K, payload?: EventParamsMap[K]) => void;
