...
| `initialBandwidthEstimateKbps` | `number`                                                        | Initial bandwidth estimate (kbps) for HLS.js ABR                                                                                                                                                                                                                                                                                                                                                 | `undefined`                                                       |
| `initialEstimateSegments`  | `number`                                                            | Segments that use initial estimate before switching to measured bandwidth                                                                                                                                                                                                                                                                                                                         | `undefined`                                                       |
| `minPreloadSegments`       | `number`                                                            | Buffer this many segments before allowing playback                                                                                                                                                                                                                                                                                                                                                | `undefined`                                                       |
