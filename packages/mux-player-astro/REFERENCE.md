...
| `minBandwidthSampleDurationMs` | `number` (ms)                                                   | Override the hls.js EWMA bandwidth estimator minimum sample-duration floor. Defaults to the upstream hls.js value (`50`).                                                                                                                                                                                                                                                                         | `50`                                                              |
