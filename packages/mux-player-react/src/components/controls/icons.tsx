...
export const Airplay = (props: any) => (
  <svg
    ...
    {...props}
  >
    <title>{"Mux Player SVG Icons_v2"}</title>
    <path d="M10.19 11.22a.25.25 0 0 0-.38 0l-5.46 6.37a.25.25 0 0 0 .19.41h10.92a.25.25 0 0 0 .19-.41Z" />
    <path d="M19 0H1a1 1 0 0 0-1 1v13a1 1 0 0 0 1 1h2.94L5 13.75H1.25V1.25h17.5v12.5H15L16.06 15H19a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1Z" />
  </svg>
);
...
export const Pause = (props: any) => (
  ...
  >
    <title>{"Mux Player SVG Icons_v2"}</title>
    <path d="M.5 18h4a.51.51 0 0 0 .5-.5V.5a.51.51 0 0 0-.5-.5h-4a.51.51 0 0 0-.5.5v17a.51.51 0 0 0 .5.5ZM10 .5v17a.51.51 0 0 0 .5.5h4a.51.51 0 0 0 .5-.5V.5a.51.51 0 0 0-.5-.5h-4a.51.51 0 0 0-.5.5Z" />
  </svg>
);
...
export const Play = (props: any) => (
  ...
  >
    <title>{"Mux Player SVG Icons_v2"}</title>
    <path d="m.73 17.93 14.05-8.54a.46.46 0 0 0 0-.78L.73.07A.48.48 0 0 0 0 .46v17.07a.48.48 0 0 0 .73.4Z" />
  </svg>
);
...
export const Pip = (props: any) => (
  ...
  >
    <title>{"Mux Player SVG Icons_v2"}</title>
    <path d="M19 0H1a1 1 0 0 0-1 1v16a1 1 0 0 0 1 1h6.75v-1.25h-6.5V1.25h17.5v6.5H20V1a1 1 0 0 0-1-1Zm0 10h-8a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1Zm-.5 6.5h-7v-5h7Z" />
  </svg>
);
...
export const SeekBackward = (props: any) => (
  ...
  >
    <title>{"Mux Player SVG Icons_v2"}</title>
    <path d="M8.75 3.42H4.68l2.14-2.14A.75.75 0 0 0 5.76.22L2.22 3.75a.77.77 0 0 0 0 1.07l3.54 3.53a.75.75 0 0 0 1.06 0 .75.75 0 0 0 0-1.06L4.45 4.92h4.3A5.75 5.75 0 0 1 11 16a.75.75 0 0 0 .29 1.44.72.72 0 0 0 .29-.06A7.25 7.25 0 0 0 8.75 3.42Z" />
    <text
...
export const SeekForward = (props: any) => (
  ...
  >
    <title>{"Mux Player SVG Icons_v2"}</title>
    <path d="M7.25 3.42h4.07L9.18 1.28A.75.75 0 0 1 10.24.22l3.54 3.53a.77.77 0 0 1 0 1.07l-3.54 3.53a.75.75 0 0 1-1.06 0 .75.75 0 0 1 0-1.06l2.37-2.37h-4.3A5.75 5.75 0 0 0 5 16a.75.75 0 0 1-.29 1.44.72.72 0 0 1-.29-.06A7.25 7.25 0 0 1 7.25 3.42Z" />
    <text
...
export const VolumeHigh = (props: any) => (
  ...
  >
    <title>{"Mux Player SVG Icons_v2"}</title>
    <path d="m8.14 1.86-4 4a.49.49 0 0 1-.35.14H.25a.25.25 0 0 0-.25.25v5.5a.25.25 0 0 0 .25.25h3.54a.49.49 0 0 1 .36.15l4 4a.5.5 0 0 0 .85-.36V2.21a.5.5 0 0 0-.86-.35ZM10.88.3v1.52A7.52 7.52 0 0 1 16.47 9a7.52 7.52 0 0 1-5.59 7.18v1.52A9 9 0 0 0 18 9 9 9 0 0 0 10.88.3ZM14.44 9a5.49 5.49 0 0 0-3.56-5.1v1.66a3.93 3.93 0 0 1 0 6.88v1.66A5.49 5.49 0 0 0 14.44 9Z" />
    <path
      style={{
        fill: "none",
      }}
...
export const VolumeLow = (props: any) => (
  ...
  >
    <title>{"Mux Player SVG Icons_v2"}</title>
    <path d="m8.14 1.86-4 4a.49.49 0 0 1-.35.14H.25a.25.25 0 0 0-.25.25v5.5a.25.25 0 0 0 .25.25h3.54a.49.49 0 0 1 .36.15l4 4a.5.5 0 0 0 .85-.36V2.21a.5.5 0 0 0-.86-.35ZM14.44 9a5.49 5.49 0 0 0-3.56-5.1v1.66a3.93 3.93 0 0 1 0 6.88v1.66A5.49 5.49 0 0 0 14.44 9Z" />
    <path
      style={{
        fill: "none",
      }}
...
export const VolumeOff = (props: any) => (
  ...
  >
    <title>{"Mux Player SVG Icons_v2"}</title>
    <path d="m0 1.05 4.48 4.47-.33.33a.49.49 0 0 1-.36.15H.25a.25.25 0 0 0-.25.25v5.5a.25.25 0 0 0 .25.25h3.54a.49.49 0 0 1 .36.15l4 4a.48.48 0 0 0 .36.15.5.5 0 0 0 .5-.5v-5.75l4.67 4.66a7.71 7.71 0 0 1-2.79 1.47v1.52a9.32 9.32 0 0 0 3.87-1.91L17 18l1-1L1.06 0Zm5.36 5.36L7.75 8.8V14L5 11.26a1.74 1.74 0 0 0-1.24-.51H1.25v-3.5h2.54A1.74 1.74 0 0 0 5 6.74ZM16.47 9a7.19 7.19 0 0 1-.89 3.47l1.11 1.1A8.64 8.64 0 0 0 18 9 9 9 0 0 0 10.88.3v1.52A7.52 7.52 0 0 1 16.47 9ZM9 5.88V2.21a.5.5 0 0 0-.5-.5.48.48 0 0 0-.36.15L6.56 3.44ZM12.91 9a4.28 4.28 0 0 1-.07.72l1.22 1.22A5.2 5.2 0 0 0 14.44 9a5.49 5.49 0 0 0-3.56-5.1v1.66A4 4 0 0 1 12.91 9Z" />
    <path
      style={{
        fill: "none",
      }}
