...
`;var B=class extends s.HTMLElement{constructor(e={}){var i;if(super(),jt(this,ho),jt(this,Be,void 0),this.preventClick=!1,this.tooltipEl=null,this.tooltipContent="",jt(this,ti,a=>{this.preventClick||this.handleClick(a),setTimeout(Q(this,pt),0)}),jt(this,pt,()=>{var a,r;(r=(a=this.tooltipEl)==null?void 0:a.updateXOffset)==null||r.call(a)}),jt(this,ei,a=>{let{key:r}=a;if(!this.keysUsed.includes(r)){this.removeEventListener("keyup",Q(this,ei));return}this.preventClick||this.handleClick(a)}),jt(this,ar,a=>{let{metaKey:r,altKey:o,key:l}=a;if(r||o||!this.keysUsed.includes(l)){this.removeEventListener("keyup",Q(this,ei));return}this.addEventListener("keyup",Q(this,ei),{once:!0})}),!this.shadowRoot){this.attachShadow({mode:"open"});let a=Ad.content.cloneNode(!0);this.nativeEl=a;let r=e.slotTemplate;r||(r=c.createElement("template"),r.innerHTML=`<slot>${e.defaultContent||""}</slot>`),e.tooltipContent&&(a.querySelector('slot[name="tooltip-content"]').innerHTML=(i=e.tooltipContent)!=null?i:"",this.tooltipContent=e.tooltipContent),this.nativeEl.appendChild(r.content.cloneNode(!0)),this.shadowRoot.appendChild(a)}this.tooltipEl=this.shadowRoot.querySelector("media-tooltip")}static get observedAttributes(){return["disabled",ht.TOOLTIP_PLACEMENT,C.MEDIA_CONTROLLER]}enable(){this.addEventListener("click",Q(this,ti)),this.addEventListener("keydown",Q(this,ar)),this.tabIndex=0}disable(){this.removeEventListener("click",Q(this,ti)),this.removeEventListener("keydown",Q(this,ar)),this.removeEventListener("keyup",Q(this,ei)),this.tabIndex=-1}attributeChangedCallback(e,i,a){var r,o,l,d,u;e===C.MEDIA_CONTROLLER?(i&&((o=(r=Q(this,Be))==null?void 0:r.unassociateElement)==null||o.call(r,this),ir(this,Be,null)),a&&this.isConnected&&(ir(this,Be,(l=this.getRootNode())==null?void 0:l.getElementById(a)),(u=(d=Q(this,Be))==null?void 0:d.associateElement)==null||u.call(d,this))):e==="disabled"&&a!==i?a==null?this.enable():this.disable():e===ht.TOOLTIP_PLACEMENT&&this.tooltipEl&&a!==i&&(this.tooltipEl.placement=a),Q(this,pt).call(this)}connectedCallback(){var e,i,a;let{style:r}=N(this.shadowRoot,":host");r.setProperty("display",`var(--media-control-display, var(--${this.localName}-display, inline-flex))`),this.hasAttribute("disabled")?this.disable():this.enable(),this.setAttribute("role","button");let o=this.getAttribute(C.MEDIA_CONTROLLER);o&&(ir(this,Be,(e=this.getRootNode())==null?void 0:e.getElementById(o)),(a=(i=Q(this,Be))==null?void 0:i.associateElement)==null||a.call(i,this)),s.customElements.whenDefined("media-tooltip").then(()=>Im(this,ho,_d).call(this))}disconnectedCallback(){var e,i;this.disable(),(i=(e=Q(this,Be))==null?void 0:e.unassociateElement)==null||i.call(e,this),ir(this,Be,null),this.removeEventListener("mouseenter",Q(this,pt)),this.removeEventListener("focus",Q(this,pt)),this.removeEventListener("click",Q(this,ti))}get keysUsed(){return["Enter"," "]}get tooltipPlacement(){return S(this,ht.TOOLTIP_PLACEMENT)}set tooltipPlacement(e){M(this,ht.TOOLTIP_PLACEMENT,e)}get mediaController(){return S(this,C.MEDIA_CONTROLLER)}set mediaController(e){M(this,C.MEDIA_CONTROLLER,e)}get disabled(){return A(this,ht.DISABLED)}set disabled(e){y(this,ht.DISABLED,e)}get noTooltip(){return A(this,ht.NO_TOOLTIP)}set noTooltip(e){y(this,ht.NO_TOOLTIP,e)}handleClick(e){}};Be=new WeakMap;ti=new WeakMap;pt=new WeakMap;ei=new WeakMap;ar=new WeakMap;ho=new WeakSet;_d=function(){this.addEventListener("mouseenter",Q(this,pt)),this.addEventListener("focus",Q(this,pt)),this.addEventListener("click",Q(this,ti));let t=this.tooltipPlacement;t&&this.tooltipEl&&(this.tooltipEl.placement=t)};s.customElements.get("media-chrome-button")||s.customElements.define("media-chrome-button",B);var vo=B;var yd=`<svg aria-hidden="true" viewBox="0 0 26 24">
...
ce-la-react/dist/ce-la-react.js:
   ...
   *)
*/
//# sourceMappingURL=-EYQ6PT34.mjs.map
