...
`;var q={MUX_UPLOADER:"mux-uploader",OVERLAY_TEXT:"overlay-text"},z,m,k,H=class extends a.HTMLElement{constructor(){super();l(this,z);l(this,m);l(this,k);let e=this.attachShadow({mode:"open"});e.appendChild(ee.content.cloneNode(!0)),u(this,z,e.getElementById("overlay-label"))}connectedCallback(){if(u(this,m,h(this)),u(this,k,new AbortController),r(this,m)){let e={signal:r(this,k).signal};r(this,m).addEventListener("file-ready",()=>this.toggleAttribute("file-ready",!0),e),r(this,m).addEventListener("uploadstart",()=>this.toggleAttribute("upload-in-progress",!0),e),r(this,m).addEventListener("success",()=>{this.toggleAttribute("upload-in-progress",!1),this.toggleAttribute("upload-complete",!0)},e),r(this,m).addEventListener("reset",()=>{this.toggleAttribute("file-ready",!1),this.toggleAttribute("upload-in-progress",!1),this.toggleAttribute("upload-complete",!1)},e),this.setupDragEvents(e),this.toggleAttribute("upload-in-progress",r(this,m).hasAttribute("upload-in-progress")),this.toggleAttribute("upload-complete",r(this,m).hasAttribute("upload-complete")),this.toggleAttribute("file-ready",r(this,m).hasAttribute("file-ready"))}}disconnectedCallback(){var e;(e=r(this,k))==null||e.abort()}attributeChangedCallback(e,s,i){e===q.OVERLAY_TEXT&&s!==i?r(this,z).innerHTML=i!=null?i:"":e==="active"&&this.hasAttribute("overlay")&&i!=null&&(this._currentDragTarget=this)}static get observedAttributes(){return[q.OVERLAY_TEXT,q.MUX_UPLOADER,"active"]}setupDragEvents(e){this.addEventListener("dragenter",s=>{this._currentDragTarget=s.target,s.preventDefault(),s.stopPropagation(),this.toggleAttribute("active",!0)},e),this.addEventListener("dragleave",s=>{this._currentDragTarget===s.target&&(this._currentDragTarget=void 0,this.toggleAttribute("active",!1))},e),this.addEventListener("dragover",s=>{s.preventDefault(),s.stopPropagation()},e),this.addEventListener("drop",s=>{var A;s.preventDefault(),s.stopPropagation();let{dataTransfer:i}=s,{files:n}=i,y=n[0];((A=r(this,m))!=null?A:this).dispatchEvent(new CustomEvent("file-ready",{composed:!0,bubbles:!0,detail:y})),this.removeAttribute("active")},e)}};z=new WeakMap,m=new WeakMap,k=new WeakMap;a.customElements.get("mux-uploader-drop")||(a.customElements.define("mux-uploader-drop",H),a.MuxUploaderDropElement=H);var be=H;function te(o){return`${Math.floor(o)}%`}var re=p.createElement("template"),Ee="Media upload progress bar";re.innerHTML=`
<style>
  :host {
    width: 100%;
    display: flex;
...
`;var f,M,D=class extends a.HTMLElement{constructor(){var s,i,n,y;super();l(this,f);l(this,M);this.onUploadStart=()=>{var e;(e=this.progressBar)==null||e.focus(),this.toggleAttribute("upload-in-progress",!0)};this.onProgress=e=>{var i;let s=e.detail;switch((i=this.progressBar)==null||i.setAttribute("aria-valuenow",`${Math.floor(s)}`),this.getAttribute("type")){case x.BAR:{this.progressBar&&(this.progressBar.style.width=`${s}%`);break}case x.RADIAL:{if(this.svgCircle){let n=this.getCircumference()-s/100*this.getCircumference();this.svgCircle.style.strokeDashoffset=n.toString()}break}case x.PERCENTAGE:{this.uploadPercentage&&(this.uploadPercentage.innerHTML=te(s));break}}};this.onSuccess=()=>{this.toggleAttribute("upload-in-progress",!1),this.toggleAttribute("upload-complete",!0)};this.onReset=()=>{this.toggleAttribute("upload-in-progress",!1),this.uploadPercentage&&(this.uploadPercentage.innerHTML=""),this.svgCircle&&(this.svgCircle.style.strokeDashoffset=`${this.getCircumference()}`)};this.attachShadow({mode:"open"}).appendChild(re.content.cloneNode(!0)),this.svgCircle=(s=this.shadowRoot)==null?void 0:s.querySelector("circle"),this.progressBar=(i=this.shadowRoot)==null?void 0:i.getElementById("progress-bar"),this.uploadPercentage=(n=this.shadowRoot)==null?void 0:n.getElementById("percentage-type"),(y=this.progressBar)==null||y.setAttribute("aria-description",Ee)}connectedCallback(){if(this.setDefaultType(),u(this,f,h(this)),u(this,M,new AbortController),r(this,f)){let e={signal:r(this,M).signal};r(this,f).addEventListener("uploadstart",this.onUploadStart,e),r(this,f).addEventListener("reset",this.onReset),r(this,f).addEventListener("progress",this.onProgress),r(this,f).addEventListener("success",this.onSuccess),this.toggleAttribute("upload-in-progress",r(this,f).hasAttribute("upload-in-progress")),this.toggleAttribute("upload-complete",r(this,f).hasAttribute("upload-complete"))}}disconnectedCallback(){var e;(e=r(this,M))==null||e.abort()}getRadius(){var e;return Number((e=this.svgCircle)==null?void 0:e.getAttribute("r"))}getCircumference(){return this.getRadius()*2*Math.PI}setDefaultType(){let e=this.getAttribute("type");e||this.setAttribute("type",x.BAR),e===x.RADIAL&&this.svgCircle&&(this.svgCircle.style.strokeDasharray=`${this.getCircumference()} ${this.getCircumference()}`,this.svgCircle.style.strokeDashoffset=`${this.getCircumference()}`)}};f=new WeakMap,M=new WeakMap;a.customElements.get("mux-uploader-progress")||a.customElements.define("mux-uploader-progress",D);var ye=D;var se=p.createElement("template");se.innerHTML=`
<style>
...
`;var c,C,F=class extends a.HTMLElement{constructor(){var s;super();l(this,c);l(this,C);this.clearStatusMessage=()=>{this.toggleAttribute("upload-error",!1),this.statusMessage&&(this.statusMessage.innerHTML="")};this.onUploadError=e=>{this.toggleAttribute("upload-error",!0),this.statusMessage&&(this.statusMessage.innerHTML=e.detail.message)};this.onSuccess=()=>{this.toggleAttribute("upload-error",!1);let e="Upload complete!";this.statusMessage&&(this.statusMessage.innerHTML=e),console.info(e)};this.onOffline=()=>{this.toggleAttribute("upload-error",!1);let e="Currently offline. Upload will resume automatically when online.";this.statusMessage&&(this.statusMessage.innerHTML=e)};this.attachShadow({mode:"open"}).appendChild(se.content.cloneNode(!0)),this.statusMessage=(s=this.shadowRoot)==null?void 0:s.getElementById("status-message")}connectedCallback(){if(u(this,c,h(this)),u(this,C,new AbortController),r(this,c)){let e={signal:r(this,C).signal};r(this,c).addEventListener("reset",this.clearStatusMessage,e),r(this,c).addEventListener("uploaderror",this.onUploadError,e),r(this,c).addEventListener("success",this.onSuccess,e),r(this,c).addEventListener("uploadstart",this.clearStatusMessage,e),r(this,c).addEventListener("offline",this.onOffline,e),r(this,c).addEventListener("online",this.clearStatusMessage,e),this.toggleAttribute("upload-in-progress",r(this,c).hasAttribute("upload-in-progress")),this.toggleAttribute("upload-complete",r(this,c).hasAttribute("upload-complete")),this.toggleAttribute("upload-error",r(this,c).hasAttribute("upload-error"))}}disconnectedCallback(){var e;(e=r(this,C))==null||e.abort()}};c=new WeakMap,C=new WeakMap;a.customElements.get("mux-uploader-status")||a.customElements.define("mux-uploader-status",F);var ve=F;var oe=p.createElement("template");oe.innerHTML=`
<style>
  #retry-button {
    color: #e22c3e;
...
`;var E,T,_=class extends a.HTMLElement{constructor(){var s;super();l(this,E);l(this,T);this.handleKeyup=e=>{let s=["Enter"," "],{key:i}=e;s.includes(i)&&this.triggerReset()};this.triggerReset=()=>{var e;(e=r(this,E))==null||e.dispatchEvent(new CustomEvent("reset"))};this.attachShadow({mode:"open"}).appendChild(oe.content.cloneNode(!0)),this.retryButton=(s=this.shadowRoot)==null?void 0:s.getElementById("retry-button")}connectedCallback(){var e,s;if(u(this,E,h(this)),u(this,T,new AbortController),r(this,E)){let i={signal:r(this,T).signal};r(this,E).addEventListener("uploaderror",()=>this.toggleAttribute("upload-error",!0)),r(this,E).addEventListener("reset",()=>this.toggleAttribute("upload-error",!1)),(e=this.retryButton)==null||e.addEventListener("click",this.triggerReset,i),(s=this.retryButton)==null||s.addEventListener("keyup",this.handleKeyup,i),this.toggleAttribute("upload-error",r(this,E).hasAttribute("upload-error"))}}disconnectedCallback(){var e;(e=r(this,T))==null||e.abort()}};E=new WeakMap,T=new WeakMap;a.customElements.get("mux-uploader-retry")||a.customElements.define("mux-uploader-retry",_);var xe=_;var ie=p.createElement("template");ie.innerHTML=`
<style>
#pause-button {
  cursor: pointer;
  line-height: 16px;
...
`;var d,w,O=class extends a.HTMLElement{constructor(){super();l(this,d);l(this,w);this.triggerPause=()=>{if(!r(this,d)){console.warn("pausing before a mux-uploader element is associated is unsupported!");return}this.pauseButton.disabled||(r(this,d).paused=!r(this,d).paused)};this.attachShadow({mode:"open"}).appendChild(ie.content.cloneNode(!0))}connectedCallback(){if(u(this,d,h(this)),u(this,w,new AbortController),r(this,d)){let e={signal:r(this,w).signal};r(this,d).addEventListener("uploadstart",()=>this.toggleAttribute("upload-in-progress",!0),e),r(this,d).addEventListener("uploaderror",()=>{this.toggleAttribute("upload-error",!0),this.toggleAttribute("upload-complete",!1),this.toggleAttribute("upload-in-progress",!1)}),r(this,d).addEventListener("success",()=>{this.toggleAttribute("upload-complete",!0),this.toggleAttribute("upload-error",!1),this.toggleAttribute("upload-in-progress",!1)}),r(this,d).addEventListener("reset",()=>{this.toggleAttribute("upload-error",!1),this.toggleAttribute("upload-in-progress",!1),this.toggleAttribute("upload-complete",!1)}),r(this,d).addEventListener("pausedchange",()=>{var i;if(this.pauseButton.disabled=!1,!r(this,d))return;let s=(i=r(this,d).paused)!=null?i:!1;this.pauseButton.innerHTML=s?"Pausing...":"Pause",s&&(this.pauseButton.disabled=!0,r(this,d).addEventListener("chunksuccess",()=>{var n;this.pauseButton.innerHTML=(n=r(this,d))!=null&&n.paused?"Resume":"Pause",this.pauseButton.disabled=!1},{once:!0}))}),this.pauseButton.addEventListener("click",this.triggerPause,e),this.toggleAttribute("upload-in-progress",r(this,d).hasAttribute("upload-in-progress")),this.toggleAttribute("upload-complete",r(this,d).hasAttribute("upload-complete")),this.toggleAttribute("upload-error",r(this,d).hasAttribute("upload-error"))}}disconnectedCallback(){var e;(e=r(this,w))==null||e.abort()}get pauseButton(){var e;return(e=this.shadowRoot)==null?void 0:e.getElementById("pause-button")}};d=new WeakMap,w=new WeakMap;a.customElements.get("mux-uploader-pause")||a.customElements.define("mux-uploader-pause",O);var Ae=O;var j=`
  <style>
  #file-select {
    cursor: pointer;
    line-height: 16px;
