...
`;var I,be=class extends d.HTMLElement{constructor(){var n;super();c(this,I);this.attachShadow({mode:"open"}).appendChild(Rt.content.cloneNode(!0)),this.srOnlyText=(n=this.shadowRoot)==null?void 0:n.getElementById("sr-only")}connectedCallback(){f(this,I,w(this)),i(this,I)&&i(this,I).addEventListener("success",this.updateText.bind(this))}disconnectedCallback(){i(this,I)&&i(this,I).removeEventListener("success",this.updateText.bind(this))}updateText(){this.srOnlyText&&(this.srOnlyText.textContent="Upload complete!")}};I=new WeakMap;d.customElements.get("mux-uploader-sr-text")||d.customElements.define("mux-uploader-sr-text",be);var Lr=be;var jn=Lt;export{vr as MuxUploaderDropElement,Ar as MuxUploaderFileSelectElement,xr as MuxUploaderPauseElement,Cr as MuxUploaderProgressElement,wr as MuxUploaderRetryElement,Lr as MuxUploaderSrTextElement,Sr as MuxUploaderStatusElement,we as constants,jn as default};
