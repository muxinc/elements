...
export const getStreamTypeFromAttr = (streamTypeAttr: string | null | undefined) => {
  ...
  if ([StreamTypes.LIVE, StreamTypes.ON_DEMAND].includes(streamTypeAttr as any)) return streamTypeAttr;
