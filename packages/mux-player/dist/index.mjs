...
`;import{TemplateInstance as Bt,ChildNodePart as fe,AttrPart as ye}from"media-chrome/dist/media-theme-element.js";var re=new WeakMap,Ne=class t{constructor(a,e){this.element=a;this.type=e;this.element.addEventListener(this.type,this);let i=re.get(this.element);i&&i.set(this.type,this)}set(a){if(typeof a=="function")this.handleEvent=a.bind(this.element);else if(typeof a=="object"&&typeof a.handleEvent=="function")this.handleEvent=a.handleEvent.bind(a);else{this.element.removeEventListener(this.type,this);let e=re.get(this.element);e&&e.delete(this.type)}}static for(a){re.has(a.element)||re.set(a.element,new Map);let e=a.attributeName.slice(2),i=re.get(a.element);return i&&i.has(e)?i.get(e):new t(a.element,e)}};function Kt(t,a){return t instanceof ye&&t.attributeName.startsWith("on")?(Ne.for(t).set(a),t.element.removeAttributeNS(t.attributeNamespace,t.attributeName),!0):!1}function Ht(t,a){return a instanceof ge&&t instanceof fe?(a.renderInto(t),!0):!1}function Yt(t,a){return a instanceof DocumentFragment&&t instanceof fe?(a.childNodes.length&&t.replace(...a.childNodes),!0):!1}function Ft(t,a){if(t instanceof ye){let e=t.attributeNamespace,i=t.element.getAttributeNS(e,t.attributeName);return String(a)!==i&&(t.value=String(a)),!0}return t.value=String(a),!0}function $t(t,a){if(t instanceof ye&&a instanceof Element){let e=t.element;return e[t.attributeName]!==a&&(t.element.removeAttributeNS(t.attributeNamespace,t.attributeName),e[t.attributeName]=a),!0}return!1}function Wt(t,a){if(typeof a=="boolean"&&t instanceof ye){let e=t.attributeNamespace,i=t.element.hasAttributeNS(e,t.attributeName);return a!==i&&(t.booleanValue=a),!0}return!1}function Zt(t,a){return a===!1&&t instanceof fe?(t.replace(""),!0):!1}function Gt(t,a){$t(t,a)||Wt(t,a)||Kt(t,a)||Zt(t,a)||Ht(t,a)||Yt(t,a)||Ft(t,a)}var Se=new Map,Je=new WeakMap,et=new WeakMap,ge=class{constructor(a,e,i){this.strings=a;this.values=e;this.processor=i;this.stringsKey=this.strings.join("")}get template(){if(Se.has(this.stringsKey))return Se.get(this.stringsKey);{let a=j.createElement("template"),e=this.strings.length-1;return a.innerHTML=this.strings.reduce((i,r,o)=>i+r+(o<e?`{{ ${o} }}`:""),""),Se.set(this.stringsKey,a),a}}renderInto(a){var r;let e=this.template;if(Je.get(a)!==e){Je.set(a,e);let o=new Bt(e,this.values,this.processor);et.set(a,o),a instanceof fe?a.replace(...o.children):a.appendChild(o);return}let i=et.get(a);(r=i==null?void 0:i.update)==null||r.call(i,this.values)}},jt={processCallback(t,a,e){var i;if(e){for(let[r,o]of a)if(r in e){let d=(i=e[r])!=null?i:"";Gt(o,d)}}}};function F(t,...a){return new ge(t,a,jt)}function tt(t,a){t.renderInto(a)}import{StreamTypes as Xt,toMuxVideoURL as at}from"@mux/playback-core";var zt=t=>{let{tokens:a}=t;return a.drm?":host { --_cast-button-drm-display: none; }":""},it=t=>F`
  <style>
    ${zt(t)}
    ${Qe}
  </style>
  ${ta(t)}
`,qt=t=>{let a=t.hotKeys?`${t.hotKeys}`:"";return ae(t.streamType)==="live"&&(a+=" noarrowleft noarrowright"),a},Qt={TOP:"top",CENTER:"center",BOTTOM:"bottom",LAYER:"layer",MEDIA_LAYER:"media-layer",POSTER_LAYER:"poster-layer",VERTICAL_LAYER:"vertical-layer",CENTERED_LAYER:"centered-layer",GESTURE_LAYER:"gesture-layer",CONTROLLER_LAYER:"controller",BUTTON:"button",RANGE:"range",DISPLAY:"display",CONTROL_BAR:"control-bar",MENU_BUTTON:"menu-button",MENU:"menu",OPTION:"option",POSTER:"poster",LIVE:"live",PLAY:"play",PRE_PLAY:"pre-play",SEEK_BACKWARD:"seek-backward",SEEK_FORWARD:"seek-forward",MUTE:"mute",CAPTIONS:"captions",AIRPLAY:"airplay",PIP:"pip",FULLSCREEN:"fullscreen",CAST:"cast",PLAYBACK_RATE:"playback-rate",VOLUME:"volume",TIME:"time",TITLE:"title",AUDIO_TRACK:"audio-track",RENDITION:"rendition"},Jt=Object.values(Qt).join(", "),ea=(t,a)=>{var i,r,o,d,l,p,x,w,E,y,_,M,h,K,I,P,X,z,q,Q,J,me;let e={"target-live-window":(i=a.targetLiveWindow)!=null?i:!1,"stream-type":(r=ae(a.streamType))!=null?r:!1,crossorigin:(o=a.crossOrigin)!=null?o:"",playsinline:"",autoplay:(d=a.autoplay)!=null?d:!1,muted:(l=a.muted)!=null?l:!1,loop:(p=a.loop)!=null?p:!1,preload:(x=a.preload)!=null?x:!1,debug:(w=a.debug)!=null?w:!1,"prefer-cmcd":(E=a.preferCmcd)!=null?E:!1,"disable-tracking":(y=a.disableTracking)!=null?y:!1,"disable-cookies":(_=a.disableCookies)!=null?_:!1,"prefer-playback":(M=a.preferPlayback)!=null?M:!1,"start-time":a.startTime!=null?a.startTime:!1,"beacon-collection-domain":(h=a.beaconCollectionDomain)!=null?h:!1,"player-init-time":(K=a.playerInitTime)!=null?K:!1,"player-software-name":(I=a.playerSoftwareName)!=null?I:!1,"player-software-version":(P=a.playerSoftwareVersion)!=null?P:!1,"env-key":(X=a.envKey)!=null?X:!1,"custom-domain":(z=a.customDomain)!=null?z:!1,src:a.src?a.src:a.playbackId?at(a):!1,"cast-src":a.src?a.src:a.playbackId?at(a):!1,"cast-receiver":(q=a.castReceiver)!=null?q:!1,"drm-token":(J=(Q=a.tokens)==null?void 0:Q.drm)!=null?J:!1,exportparts:"video"};switch(t){case"mux-video-ads":return{...e,adtagurl:(me=a.adTagUrl)!=null?me:!1};default:return e}},ta=t=>{var p,x,w,E,y,_,M,h,K,I,P,X,z,q,Q;let a=t.muxVideoElement||"mux-video",e=F`
    ${t.storyboard?F`<track label="thumbnails" default kind="metadata" src="${t.storyboard}" />`:F``}
    <slot></slot>
  `,i=ea(a,t),r=[`<${a} slot='media' `],o=[];Object.entries(i).forEach(([J,me],kt)=>{kt==0?r[0]+=` ${J}="`:r.push(`" ${J}="`),o.push(me)}),r.push('">'),r.push("</"+a+">"),o.push(e);let d=Object.assign([],r,{raw:r}),l=F(d,...o);return F`
    <media-theme
      ...
      style="${(y=Fe({"--media-primary-color":t.primaryColor,"--media-secondary-color":t.secondaryColor,"--media-accent-color":t.accentColor}))!=null?y:!1}"
